...
The following features are already implemented in the glider toolbox:
  ...
  - Two processing functions to perform both modes of data processing:
      - [`gliderDataProcessing`][main_func_proc]
      - [`deploymentDataProcessing`][depl_func_proc]
...
The following features are planned or in development:
  ...
  [main_func_proc]: http://www.socib.es/users/glider/glider_toolbox/doc/m/gliderDataProcessing
  [depl_func_proc]: http://www.socib.es/users/glider/glider_toolbox/doc/m/processing_tools/deploymentDataProcessing
...
In addition, the toolbox contains a [`quick start document`][qstart] to guide users through 
...
toolbox that are configurable by the user.
  ...
  [qstart]: http://www.socib.es/users/glider/glider_toolbox/doc/QuickStart.docx
...
The [data flow diagram][procflow] illustrates the different steps of the data
...
(in other words: read the docs! ;-).
  ...
  [procflow]: http://www.socib.es/users/glider/glider_toolbox/notes/glider_data_processing_outline_real_time.pdf
