function local_paths = configDTLocalPaths()
%CONFIGDTLOCALPATHS  Config local paths for glider deployment delayed time data and figures.
%
%  LOCAL_PATHS = CONFIGDTLOCALPATHS() should return a struct with the path 
...
%
%  Examples:
%    local_paths = configDTLocalPaths()
%
%  See also:
