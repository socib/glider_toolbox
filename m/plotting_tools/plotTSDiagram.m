...
%  key - value pairs OPT1, VAL1... or in option struct OPTIONS. The line plot is
%  generated with function PLOT. Labeled contour levels are generated by 
%  functions CONTOUR and CLABELS from density measurements computed by SW_DENS0.
%  Allowed options are:
...
%  Email: joanpau.beltran@socib.cat
  ...
  set(hlns, ...
      'XData', options.sdata(valid_data), ...
      'YData', options.tdata(valid_data), ...
