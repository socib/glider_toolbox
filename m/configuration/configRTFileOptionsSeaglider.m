function seaglider_options = configRTFileOptionsSeaglider()
%CONFIGRTFILEOPTIONSSEAGLIDER  Configure loading options for Seaglider files in real time.
%
%  Syntax:
%    SEAGLIDER_OPTIONS = CONFIGRTFILEOPTIONSSEAGLIDER()
%
%  Description:
%    SEAGLIDER_OPTIONS = CONFIGRTFILEOPTIONSSEAGLIDER() should return a struct 
...
%    in real time mode. The returned struct should have the following fields:
