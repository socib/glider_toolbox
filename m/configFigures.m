...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  figures_proc.chlorophyll.dataopts.ydata = {'depth_ctd' 'depth'};
  ...
  figures_proc.turbidity.dataopts.ydata = {'depth_ctd' 'depth'};
  ...
  figures_proc.oxygen_saturation.dataopts.ydata = {'depth_ctd' 'depth'};
