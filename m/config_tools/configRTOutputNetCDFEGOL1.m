...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  param_list = ...
       struct('ego', ...
              ...
              {{'heading','roll', 'pitch', ...
                ...
                'density', 'density_corrected_thermal', ...
                ...
                'backscatter', 'turbidity', 'cdom', 'scatter_650', ...
                'time_optics', ...
                'oxygen_saturation', 'oxygen_frequency', 'time_oxygen',...
  ...
  ncl1_info.variables = listNetCDFL1Parameters(time_dimension.name, param_list);   
