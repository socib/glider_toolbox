...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  param_list = ...
       struct('ego', ...d
              {{'time', 'time_QC', ...
                'time_gps', 'time_gps_QC', ...
                'juld', 'juld_QC'...
                'depth', 'depth_QC', ...
                'latitude', 'latitude_QC', ...
                'longitude', 'longitude_QC', ...
                'position', 'position_QC', ...
                'latitude_gps', 'longitude_gps', ...
                'position_gps', 'position_gps_QC', ...
                ...
                'psal', 'psal_QC', ...
                'chla', 'chla_QC', ...
                'temp_doxy', 'temp_doxy_QC', ...
                'molar_doxy', 'molar_doxy_QC', ...
                'temp_spectrophotometer_nitrate', 'temp_spectrophotometer_nitrate_QC', ...
              ...
              {{'heading','roll', 'pitch', ...
                ...
                'time_optics', ...
                'oxygen_saturation', 'oxygen_saturation_QC', ...
  ...
  ncl1_info.variables = listNetCDFL1Parameters('', '_QC', time_dimension.name, param_list);   
