...
%CONFIGRTOUTPUTNETCDFEGOL1  Configure NetCDF output for processed glider deployment data in delayed time.
%
%  Syntax:
...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  param_list = ...
       struct('ego', ...
              {{'time', 'time_QC', 'time_UNCERTAINTY', ...
                'time_gps', 'time_gps_QC', 'time_gps_UNCERTAINTY', ...
                'juld', 'juld_QC', 'juld_UNCERTAINTY', ...
                'depth', 'depth_QC', 'depth_UNCERTAINTY', ...
                'latitude', 'latitude_QC', 'latitude_UNCERTAINTY', ...
                'longitude', 'longitude_QC', 'longitude_UNCERTAINTY', ...
                'position', 'position_QC', 'position_UNCERTAINTY', ...
                'latitude_gps', 'longitude_gps', 'longitude_gps_UNCERTAINTY',...
                'position_gps', 'position_gps_QC', 'position_gps_UNCERTAINTY', ...
                'phase', 'phase_number', 'positioning_method', ...
                'cndc', 'cndc_QC', 'cndc_UNCERTAINTY', ...
                'temp', 'temp_QC', 'temp_UNCERTAINTY', ...
                'pres', 'pres_QC', 'pres_UNCERTAINTY', ...
                'psal', 'psal_QC', 'psal_UNCERTAINTY', ...
                'chla', 'chla_QC', 'chla_UNCERTAINTY', ...
                'temp_doxy', 'temp_doxy_QC', 'temp_doxy_UNCERTAINTY', ...
                'molar_doxy', 'molar_doxy_QC', 'molar_doxy_UNCERTAINTY', ...
                'temp_spectrophotometer_nitrate', 'temp_spectrophotometer_nitrate_QC', 'temp_spectrophotometer_nitrate_UNCERTAINTY', ...
                'turbidity', 'turbidity_QC', 'turbidity_UNCERTAINTY', ...
                ...
                'deployment_start_date', 'deployment_start_QC', ...
                'deployment_end_date', 'deployment_end_QC', ...
                ...
                'deployment_end_status', 'deployment_operator', ...
              ...
              {{'heading','roll', 'pitch', ...
                ...
                'distance_over_ground', 'transect_index', ...
                'profile_index', 'profile_direction', ...
                'time_ctd', 'depth_ctd', ...
                'temperature_corrected_sensor', ...
                'temperature_corrected_thermal', ...
                'conductivity_corrected_sensor', ...
                'conductivity_corrected_thermal', ...
                'salinity_corrected_thermal', ...
                'salinity_corrected_sensor', ...
                'salinity_corrected_sensor_thermal', ...
                'density', 'density_QC', 'density_UNCERTAINTY', ...
                'density_corrected_thermal', ...
                'density_corrected_sensor', ...
                'density_corrected_sensor_thermal', ...
                'potential_temperature', 'potential_density', ...
                'sound_velocity', ...
                'backscatter_470', 'backscatter_532', ...
                'backscatter_660', 'backscatter_700', ... 
                'backscatter', 'cdom', 'scatter_650', ...
                'time_optics', ...
                'oxygen_saturation', 'oxygen_saturation_QC', 'oxygen_saturation_UNCERTAINTY', ...
                'oxygen_frequency', 'time_oxygen',...
                'irradiance_412', 'irradiance_442', ...
                'irradiance_491', 'irradiance_664', ...
                'water_velocity_eastward', 'water_velocity_northward', ...
                'fluorescence_270_340', 'fluorescence_255_360',...
