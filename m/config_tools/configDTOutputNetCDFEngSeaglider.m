function ncl0_info = configDTOutputNetCDFEngSeaglider()
%CONFIGDTOUTPUTNETCDFENGSEAGLIDER  Configure NetCDF output for raw Seaglider glider deployment data in delayed time.
%
%  Syntax:
%    NCL0_INFO = CONFIGDTOUTPUTNETCDFENGSEAGLIDER()
%
%  Description:
%    NCL0_INFO = CONFIGDTOUTPUTNETCDFENGSEAGLIDER() should return a struct
