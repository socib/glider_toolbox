function ncl0_info = configDTOutputNetCDFEngSlocum()
%CONFIGDTOUTPUTNETCDFENGSLOCUM  Configure NetCDF output for raw Slocum glider deployment data in delayed time.
%
%  Syntax:
%    NCL0_INFO = CONFIGDTOUTPUTNETCDFENGSLOCUM()
%
%  Description:
%    NCL0_INFO = CONFIGDTOUTPUTNETCDFENGSLOCUM() should return a struct
