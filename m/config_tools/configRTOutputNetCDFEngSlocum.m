function ncl0_info = configRTOutputNetCDFEngSlocum()
%CONFIGRTOUTPUTNETCDFENGSLOCUM  Configure NetCDF output for raw Slocum glider deployment data in real time.
%
%  Syntax:
%    NCL0_INFO = CONFIGRTOUTPUTNETCDFENGSLOCUM()
%
%  Description:
%    NCL0_INFO = CONFIGRTOUTPUTNETCDFENGSLOCUM() should return a struct
