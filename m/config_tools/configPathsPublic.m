function public_paths = configDTPathsPublic(glider_toolbox_dir, base_url)
...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  public_paths.base_dir    = glider_toolbox_dir;
  ...
  if exist('base_url','var')
      public_paths.base_url  = base_url;
      public_paths.figure_url  = fullfile('${GLIDER_NAME}/${DEPLOYMENT_START,Tyyyymmdd}/figures');
      public_paths.figure_info = fullfile('figures/${DEPLOYMENT_ID}.json');
  end
end
