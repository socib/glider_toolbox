function ncl0_info = configRTOutputNetCDFEngSeaExplorer()
%CONFIGRTOUTPUTNETCDFENGSEAEXPLORER  Configure NetCDF output for raw SeaExplorer glider deployment data in real time.
%
%  Syntax:
%    NCL0_INFO = CONFIGRTOUTPUTNETCDFENGSEAEXPLORER()
%
%  Description:
%    NCL0_INFO = CONFIGRTOUTPUTNETCDFENGSEAEXPLORER() should return a struct 
