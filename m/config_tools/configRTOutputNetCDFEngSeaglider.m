function ncl0_info = configRTOutputNetCDFEngSeaglider()
%CONFIGRTOUTPUTNETCDFENGSEAGLIDER  Configure NetCDF output for raw Seaglider glider deployment data in real time.
%
%  Syntax:
%    NCL0_INFO = CONFIGRTOUTPUTNETCDFENGSEAGLIDER()
%
%  Description:
%    NCL0_INFO = CONFIGRTOUTPUTNETCDFENGSEAGLIDER() should return a struct
