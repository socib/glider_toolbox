function ncl0_info = configDTOutputNetCDFEngSeaExplorer()
%CONFIGDTOUTPUTNETCDFENGSEAEXPLORER  Configure NetCDF output for raw SeaExplorer glider deployment data in delayed time.
%
%  Syntax:
%    NCL0_INFO = CONFIGDTOUTPUTNETCDFENGSEAEXPLORER()
%
%  Description:
%    NCL0_INFO = CONFIGDTOUTPUTNETCDFENGSEAEXPLORER() should return a struct 
