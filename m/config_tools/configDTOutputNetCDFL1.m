...
%  Email: joanpau.beltran@socib.cat
  ...
  var_attr_list.temperature_corrected = {
    'long_name'     'water temperature with time response corrected'
    'standard_name' 'sea_water_temperature'
    'units'         'Celsius'   
    '_FillValue'    default_fill_value };
  ...
  var_attr_list.conductivity_corrected = {
    'long_name'     'water conductivity with time response corrected'
    'standard_name' 'sea_water_conductivity'
    'units'         'S m-1'   
    '_FillValue'    default_fill_value };
  ...
  var_attr_list.salinity_corrected_temperature_thermal = {
    'long_name'     'water salinity from corrected temperature and raw conductivity with thermal lag corrected'
    'standard_name' 'sea_water_salinity'
    'units'         'PSU'
    '_FillValue'    default_fill_value };

  var_attr_list.salinity_corrected_temperature_conductivity_thermal = {
    'long_name'     'water salinity from corrected temperature and corrected conductivity with thermal lag corrected'
    'standard_name' 'sea_water_salinity'
    'units'         'PSU'   
    '_FillValue'    default_fill_value };
  ...
  var_attr_list.density_corrected_thermal = {
    'long_name'     'water density using salinity from raw temperature and raw conductivity with thermal lag corrected'
    'standard_name' 'sea_water_density'
    'units'         'Kg m-3'   
    '_FillValue'    default_fill_value };
  ...
  var_attr_list.density_corrected_temperature_conductivity_thermal = {
    'long_name'     'water density using salinity from corrected temperature and corrected conductivity with thermal lag corrected'
    'standard_name' 'sea_water_density'
    'units'         'Kg m-3'   
    '_FillValue'    default_fill_value };
