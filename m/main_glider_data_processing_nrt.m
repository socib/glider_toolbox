...
current_deployments_list = getDeploymentsForTesting();
if isempty(current_deployments_list)
    disp(['Empty list of deployments found']);

else
    for deployment_idx = 1:length(current_deployments_list)
        current_deployment = current_deployments_list{deployment_idx};
        glider_name = current_deployment.glider;
...
%                             end;
    ...
    end; % for deployment_idx = 1:length(current_deployments_list)
end; % if isempty(current_deployments_list)
