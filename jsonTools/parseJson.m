...
%
% Syntax: data = parseJson(json)
%
% Inputs: 
%    json - JSON string
%
% Outputs:
%    data - the matlab structure containing the parsed JSON information
%
% Example:
%    googleSearch = ['http://ajax.googleapis.com/', ...
%     'ajax/services/search/web?v=1.0&q=matlab'];
%    matlabResults = parseJson(urlread(googleSearch));
%    result = matlabResults{1}.responseData.results{1};
%    disp(result.titleNoFormatting);
%    disp(result.visibleUrl);
%
% Other m-files required: none
% Subfunctions: parse_value, parse_array, parse_object, parse_name_value,
%   parse_string, parse_number
% MAT-files required: none
%
% See also: STRTRIM, STRTOK, REGEXP
%
% Author: Joel Feenstra
% Work address: 
% Author e-mail: joel.feenstra@mathworks.com
% Website: http://www.mathworks.com
% Creation: 18-Jun-2009
%
